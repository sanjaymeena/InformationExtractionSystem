...
public class StanfordParserServer {
    ...
    private static String CONFIG_FILE = "D:/Eclipse/workspaces/gateplugins/IEGatePlugin/resources"+File.separator+ "core_ie_resources"+File.separator+"ie_data"+File.separator+ "stanford_parser_configuration.xml";
