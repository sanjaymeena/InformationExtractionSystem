...
public class StanfordParserServerWithPOS {
    ...
    private static String CONFIG_FILE = GlobalProperties.getPrefixPath()+File.separator+ "resources"+ File.separator+"core_ie_resources"+File.separator+"ie_data"+ File.separator+"stanford_parser_configuration.xml";
	...
	//String filePath = "resources/testdata/Articles/test##test.txt";
        ...
        serializedInputFileOrUrl = GlobalProperties.getPrefixPath()+File.separator+preferences.get("grammar");
        postaggerModelFile=GlobalProperties.getPrefixPath()+File.separator+preferences.get("postagger");
